...
parser.add_argument("-username", type=str,required=True, help="Your name")
parser.add_argument("-password", type=str,required=True, help="Your password")
parser.add_argument("-database", type=str,required=True, help="data")
parser.add_argument("-action", type=str, required=True, help="the operation to be performed")
...
def action_select():
    ...
    result = cursor.fetchall()   # reads all rows from the table
    for row in result:
        print(row)
        #print(row[0], row[1]) for indexing
